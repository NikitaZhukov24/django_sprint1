...
def post_detail(request, id: int):
    ...
    try:
        ...
        # "Не забывай, что ID поста - это не позиция в списке,
        # а поле id в словаре.
        # Поэтому для поиска по ID удобнее было бы создать
        # еще один словарь, в котором будут храниться
        # пары ID поста - позиция в списке. И этот словарь лучше
        # вне функции объявить, чтобы лишний раз
        # не создавать его"
        # Следует обратить особое внимание на ключевые слова
